...
export default function BotModal({toggleCreateBotModel, confirm, title, description}) {
    ...
    return (
        <div className="overlay">
            <div className="new_bot__modal ">
                <h2 className="title_form">Create bot</h2>
                ...
                <div className="new_bot__modal-footer">
                    ...
                    <TextButtonIcon title={"Confirm"} onPress={()=>confirm(titleBot, descriptionBot)}/>
                </div>
            </div>
        </div>
    )
